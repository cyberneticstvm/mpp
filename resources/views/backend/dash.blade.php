                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordernone">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle" src="{{ asset('/backend/assets/images/dashboard/product-1.png') }}" alt="" data-original-title="" title="">
                                                ...
                                                <td><img class="img-fluid" src="{{ asset('/backend/assets/images/dashboard/graph-1.png') }}" alt="" data-original-title="" title=""></td>
                                                <td>
                                                    <p>$210326</p>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle" src="{{ asset('/backend/assets/images/dashboard/product-2.png') }}" alt="" data-original-title="" title="">
                                                ...
                                                <td><img class="img-fluid" src="{{ asset('/backend/assets/images/dashboard/graph-2.png') }}" alt="" data-original-title="" title=""></td>
                                                <td>
                                                    <p>$548526</p>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle" src="{{ asset('/backend/assets/images/dashboard/product-3.png') }}" alt="" data-original-title="" title="">
                                                ...
                                                <td><img class="img-fluid" src="{{ asset('/backend/assets/images/dashboard/graph-3.png') }}" alt="" data-original-title="" title=""></td>
                                                <td>
                                                    <p>$589565</p>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle" src="{{ asset('/backend/assets/images/dashboard/product-4.png') }}" alt="" data-original-title="" title="">
                                                ...
                                                <td><img class="img-fluid" src="{{ asset('/backend/assets/images/dashboard/graph-4.png') }}" alt="" data-original-title="" title=""></td>
                                                <td>
                                                    <p>$125424 </p>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media"><img class="img-fluid rounded-circle" src="{{ asset('/backend/assets/images/dashboard/product-5.png') }}" alt="" data-original-title="" title="">
                                                ...
                                                <td><img class="img-fluid" src="{{ asset('/backend/assets/images/dashboard/graph-5.png') }}" alt="" data-original-title="" title=""></td>
                                                <td>
                                                    <p>$112103</p>
                                                </td>
                                                <td>
