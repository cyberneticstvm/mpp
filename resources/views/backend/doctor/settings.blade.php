                ...
                <div class="col-xl-8">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Logo Image <small>(Should be a Square Image)</small></label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    {{ html()->select('watermark_preference', array('image' => 'Image Watermark', 'text' => 'Text Watermark', 'no' => 'No Watermark'))->class('form-control')->placeholder('Select') }}
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
