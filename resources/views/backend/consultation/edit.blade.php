...
<div class="page-body">
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h3>Consultation / Medical Record Update</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Create Consultation / Medical Record Update</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-xl-12 xl-100">
                <div class="card">
                    {{ html()->form('POST', route('consultation.update', $consultation->id))->class('theme-form frmConsultation')->open() }}
                    @csrf
                    <input type="hidden" name="pid" value="{{ encrypt($consultation->patient_id) }}" />
                    <div class="card-body">
                            ...
                            <div class="tab-pane fade active show" id="pills-clrhome" role="tabpanel" aria-labelledby="pills-clrhome-tab">
                                <div class="row m-t-30">
                                    <div class="col-md-3 form-group">
                                        ...
                                        {{ html()->text('patient_name', $consultation->patient->patient_name)->class('form-control')->attribute('readonly', 'true') }}
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="control-label">Patient Id</label>
                                        {{ html()->text('patient_id', $consultation->patient->patient_id)->class('form-control')->attribute('readonly', 'true') }}
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="control-label">Date of Birth</label>
                                        {{ html()->text('dob', $consultation->patient->dob?->format('d, F Y'))->class('form-control')->attribute('readonly', 'true') }}
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="control-label">Mobile</label>
                                        {{ html()->text('mobile', $consultation->patient->mobile)->class('form-control')->attribute('readonly', 'true') }}
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label class="control-label">Address</label>
                                        {{ html()->text('address', $consultation->patient->address)->class('form-control')->attribute('readonly', 'true') }}
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="pills-clrprofile" role="tabpanel" aria-labelledby="pills-clrprofile-tab">
                                <div class="row m-t-30">
                                    <div class="col-md-6 form-group">
                                        ...
                                        {{ html()->textarea('medical_history', $consultation->medical_history)->class('form-control')->rows('5')->placeholder('Medical History if any') }}
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="control-label">Examination</label>
                                        {{ html()->textarea('examination', $consultation->examination)->class('form-control')->rows('5')->placeholder('Examination') }}
                                    </div>
                                    <div class="col-md-6 form-group">
                                        ...
                                        {{ html()->select('symptoms[]', $symptoms, $consultation->symptoms()->pluck('name'))->class('form-control select2')->attribute('id', 'selSymptom')->multiple() }}
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        {{ html()->select('diagnosis[]', $diagnoses, $consultation->diagnoses()->pluck('name'))->class('form-control select2')->attribute('id', 'selDiagnosis')->multiple() }}
                                        <small>Multiple selection enabled</small>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="control-label">Investigation</label>
                                        {{ html()->textarea('investigation', $consultation->investigation)->class('form-control')->rows('5')->placeholder('Investigation') }}
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="control-label">Advice / Referrals</label>
                                        {{ html()->textarea('advice', $consultation->advice)->class('form-control')->rows('5')->placeholder('Advice / Referrals') }}
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="control-label">Is allergic to any drugs?</label>
                                        {{ html()->textarea('allergic_drugs', $consultation->allergic_drugs)->class('form-control')->rows('5')->placeholder('Specify Details of Allergic Drugs if any') }}
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="control-label">Notes / Remarks</label>
                                        {{ html()->textarea('remarks', $consultation->remarks)->class('form-control')->rows('5')->placeholder('Notes / Remarks') }}
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="control-label">Surgery Advised?</label>
                                        {{ html()->select('surgery_advised', array('no' => 'No', 'yes' => 'Yes'), old('surgery_advised') ?? $consultation->surgery_advised)->class('form-control')->placeholder('Select') }}
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <label class="control-label">Next Review Date</label>
                                        {{ html()->text('review_date', $consultation->review_date ? $consultation->review_date->format('d, F Y') : '')->class('datepicker-here form-control digits')->attribute('data-language', 'en')->attribute('data-position', 'top left')->attribute('readonly', 'true')->placeholder('day, month year') }}
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table border-0">
                                                ...
                                                <tbody class="medTable">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            {{ html()->select('medicines[]', array('' => 'Select') + $medicines, $item->medicine_id)->class('form-control select2 selMedicine')->attribute('id', 'selMedicine') }}
                                                        </td>
                                                        <td>
                                                            {{ html()->number('qty[]', $item->qty ?? '', '', '', '1')->class('form-control')->placeholder('Qty') }}
                                                        </td>
                                                        <td>
                                                            {{ html()->text('dosage[]', $item->dosage ?? '')->class('form-control')->placeholder('Dosage') }}
                                                        </td>
                                                        <td>
                                                            {{ html()->text('duration[]', $item->duration ?? '')->class('form-control')->placeholder('Duration') }}
                                                        </td>
                                                        <td>
                                                            {{ html()->text('notes[]', $item->notes ?? '')->class('form-control')->placeholder('Notes') }}
                                                        </td>
                                ...
                                <div class="m-t-30">
                                    <div class="row m-t-30">
                                        <div class="col-md-12 form-group">
                                            ...
                                            {{ html()->select('tests[]', $tests, $consultation->tests()->pluck('name'))->class('form-control select2')->attribute('id', 'selTest')->multiple() }}
                                            <small>Multiple selection enabled</small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer text-end">
                        ...
                        <button type="submit" class="btn btn-primary btn-submit" href="">Update</button>
                    </div>
                    {{ html()->form()->close() }}
                </div>
            </div>
