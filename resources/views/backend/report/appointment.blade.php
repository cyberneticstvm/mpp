                            ...
                            <div class="col-6 dropdown-basic text-end">
                                <div class="dropdown text-start">
                                    <div class="btn-group mb-0">
                                        ...
                                        <div class="dropdown-content"><a href="{{ route('appointment.excel.export', ['from_date' => $inputs['from_date'], 'to_date' => $inputs['to_date'], 'profile' => encrypt($inputs['profile'])]) }}" target="_blank"><i class="fa fa-file-excel-o text-success"></i> Excel</a><a href="{{ route('appointment.pdf.export', ['from_date' => $inputs['from_date'], 'to_date' => $inputs['to_date'], 'profile' => encrypt($inputs['profile'])]) }}" target="_blank"><i class="fa fa-file-pdf-o text-danger"></i> Pdf</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
