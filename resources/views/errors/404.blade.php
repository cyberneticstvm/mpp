    ...
    <div class="container pt-12 pt-md-14 pb-14 pb-md-16">
        <div class="row">
            <div class="col-lg-9 col-xl-8 mx-auto">
                <figure class="mb-10"><img class="img-fluid" src="{{ asset('/frontend/assets/img/illustrations/404.png') }}" srcset="{{ asset('/frontend/assets/img/illustrations/404.png') }}" alt="404"></figure>
            </div>
            <!-- /column -->
